...
#  And clean inbox
  ...
  Scenario Outline: check validators of the negotiation frame
        Given I open the Trading application
        When I try to start some "<type>" negotiation
        Then I change <field> on <value> and validator:"<validator>" should "<presence>"
          Examples:
      |  type          | field    | value     | validator                   | presence |
      |  SALES OFFER   | price    | 0.0001    | Maximal value must be       | be       |
      |  SALES OFFER   | price    | -100000.0 | Minimal value must be 1     | be       |
      |  SALES OFFER   | price    | -0.0001   | Minimal value must be       | not be   |
      |  BUYING DEMAND | price    | -0.0001   | Minimal value must be       | be       |
      |  BUYING DEMAND | price    | 100000.0  | Maximal value must be 99999 | be       |
      |  BUYING DEMAND | price    | 0.0001    | Minimal value must be       | not be   |
      |  BUYING DEMAND | quantity | 999.1     | Maximal value must be 999   | be       |
      |  BUYING DEMAND | quantity | 999.0     | Maximal value must be 999   | not be   |
      |  BUYING DEMAND | quantity | 0.9999    | Minimal value must be 1     | be       |
      |  BUYING DEMAND | quantity | 1.0       | Minimal value must be 1     | not be   |
